...
Results for pump-and-probe model has been presented in Figure (\ref{fig:nc_pnp}). 
Results for the frequency mixing model has been presented in Figure (\ref{fig:nc_fmix1}). 
...
\begin{multline}  \label{eq:hartley_longdht}
	R_{X_k} =  
 			\sum_{n = 0}^{\lfloor \frac{N}{2} - 1 \rfloor } \left[ 2 \, n  \, x \,  \left(
 				\mathrm{cos} \left( \frac {2 \, \pi \, k \, (2 \, n) }{N} \right) \right)
