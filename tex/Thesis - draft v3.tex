...
\begin{flushleft}
\includegraphics[width=170mm]{img/pnp_2d.png}
...
\begin{flushleft}
\includegraphics[width=170mm]{img/pnp_3d.png}
...
\begin{flushleft}
\includegraphics[width=170mm]{img/fmix_2d.png}
...
\begin{flushleft}
\includegraphics[width=170mm]{img/fmix_3d.png}
...
\begin{flushleft}
\includegraphics[width=170mm]{img/qp_plot.png}
{\small 
...
\begin{flushleft}
\includegraphics[width=170mm]{img/qp_3da.png}
\includegraphics[width=170mm]{img/qp_3db.png}
\end{flushleft}
...
\begin{flushleft}
\includegraphics{img/lin_plot.png}
{\small 
...
\begin{flushleft}
\includegraphics{img/htran_lin.png}
...
\begin{flushleft}
\includegraphics{img/htran_pnp_2d.png}
...
\begin{flushleft}
\includegraphics[width=170mm]{img/htran_fmix_2d.png}
...
\begin{flushleft}
\includegraphics[width=170mm]{img/htran_qp_2da.png}
\includegraphics[width=170mm]{img/htran_qp_2da.png}
...
\begin{flushleft}
\includegraphics[width=170mm]{img/htran_qp_3d.png}
{\small 
...
\begin{flushleft}
\includegraphics{img/nc_lin1.png}
...
\begin{flushleft}
\includegraphics{img/nc_lin2.png}
...
\begin{flushleft}
\includegraphics{img/nc_lin3.png}
...
\begin{flushleft}
\includegraphics{img/nc_lin4.png}
...
\begin{flushleft}
\includegraphics[width=170mm]{img/nc_fmix1.png}
(5.3.1) 
\mapleinline{inert}{2d}{chi[pp](delta) =
G*n[0]*gamma[ba]/(Delta+delta+I*eta)*(1-Omega[1]^2*(Delta-delta+I*eta)
*(delta+2*I*eta)/(Delta-I*eta)/((delta+I*theta)*(Delta+delta+I*eta)*(d
...
\begin{flushleft}
\includegraphics[width=170mm]{img/nc_qp1.png}
(5.4.1) 
\mapleinline{inert}{2d}{chi[1,qp](omega);}{%
${\chi _{1, \,\mathit{qp}}}(\omega )$%
} = 
...
\subsection*{A - Source codes of prepared algorithms in MATLAB using
the Maple Toolbox}
...
\subsection*{B - Tutorial files for the out-of-the-box MATLAB
built-in rutines}
...
\subsection*{C - Sources files used for modeling:}
...
\begin{flushleft}
Draft info: The graphical results from Chapters 4-10 will be placed here in the
final tex version.
\end{flushleft}
