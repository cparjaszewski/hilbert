...
\begin{subequations}  \label{eq:derivation_lucarini}
  \begin{multline} \label{eq:dlucarini_imag}
    ...
    \,\ldots, \,{\omega_{n}})) = \\
    \frac {1}{( - \pi )^{n}}  \dashint_{ - \infty }^{\infty }\,\dashint_{ - \infty }^{\infty}\,\ldots\,\dashint_{ - \infty
    }^{\infty }{ \frac { \Re({\chi_{n, \,i, \,{j_{1}}, \,{j_{2}}, \,\ldots, \,{j_{n}}}}(\sum_{l=1}^{n}\,{\Omega_{l}}, \,{\Omega_{1}}, \,
  ...
  \begin{multline} \label{eq:dlucarini_real}
    ...
    \,\ldots, \,{\omega_{n}})) = \\
    \frac {1}{\pi^{n}} \dashint_{ - \infty }^{\infty }\,\dashint_{ - \infty }^{\infty}\,\ldots\,\dashint_{ - \infty }^{\infty }
    \frac { \Im ({\chi_{n, \,i, \,{j_{1}}, \,{j_{2}}, \,\ldots, \,{j_{n}}}}(\sum_{l=1}^{n}\,{\Omega_{l}}, \,{\Omega_{1}}, \, {\Omega_{2}}, \ldots,
