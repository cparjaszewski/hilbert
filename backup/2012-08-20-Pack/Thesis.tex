...
As the input R function is assumed to be square-integrable, we will put even more strict assumption:
...
We will also need to approximate the values of a new $\widehat{R}$ at $\widehat{F_j} (j = 1 \ldots N-1)$  values. We will do this by a
